...
Để chạy cypress và code cypress cần: Cài đặt **node** và **yarn** trên máy
```
...
```
*Cách trên tự động cài **node** luôn. Nếu đã cài **node** thì thay vì chạy câu lệnh cuối thì chạy*
```
...
```
**Trường hợp xuất hiện lỗi chưa cài đặt Cypress thì chạy câu lệnh sau trước khi chạy câu lệnh cuối**
```

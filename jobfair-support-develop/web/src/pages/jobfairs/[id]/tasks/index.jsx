          ...
          <Tooltip title={taskName}>
            <div className="inline">
              <Link href={`/jobfairs/${JFId}/tasks/${record.idtask}`}>
                <a className={parentId.includes(record.key) ? '' : 'task-children'}>
              ...
              <DeleteTwoTone
                ...
                onClick={() => {
                  setSelectedData((prev) => {
                    if (record.is_parent === 1) {
                      const newList = prev.filter((task) => task.key !== record.key && !record.children.map((item) => item.key).includes(task.key))
                      return newList
                    }
        ...
        <div className="TaskList">
          <div className=" justify-center">
            ...
            <Table
              ...
              rowSelection={{ onChange: isRowChecked, checkStrictly: false }}
